...
export type ImageName = "sword" | "pillars" | "lavafly" | "pillarSpiral";

const imageInformation: Record<ImageName, string> = {
    sword: `http://${ServerTalker.hostName}/images/sword.png`,
    pillars: `http://${ServerTalker.hostName}/images/pillars.png`,
    pillarSpiral: `http://${ServerTalker.hostName}/images/pillarSpiral.png`,
    lavafly: `http://${ServerTalker.hostName}/images/lavafly.png`,
